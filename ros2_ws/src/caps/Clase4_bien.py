...
class Template(object):
	def __init__(self, args):
		...
		self.args = args
		self.sub = node.create_subscriber(Image,"/duckiebot/camera_node/image/raw",  self.procesar_img) #cambia la estructura del subscriber
		self.pub = rclpy.Publisher(Image,"/duckiebot/camera_node/image/yellow", queue_size = 10) #cambia la estructura del publisher
...
def main():
    ...
    node = rclpy.create_node('clase 4') #creacion y registro del nodo!
